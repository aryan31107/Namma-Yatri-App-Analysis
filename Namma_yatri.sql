...
on a.id = b.faremethod;
----------------------------------------------------------------------------
--Which two locations had the most trips (from which location to which location customers are travelling the most)
select * from
...
where rnk=1;
------------------------checking for all durations------------------------
--Which location got the highest no of trips in each duration present
select * from
...
group by duration,loc_from)b)c
where rnk=1;
------------------------checking for all locations------------------------
--Which duration got the highest no of trips in each of the location present
select * from
